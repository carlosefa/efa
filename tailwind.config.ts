...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'neon': '0 0 20px -5px hsl(var(--primary) / 0.4)',
        'neon-strong': '0 0 30px -5px hsl(var(--primary) / 0.6)',
      ...
      backgroundImage: {
        ...
        'gradient-cyber': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--accent)) 50%, hsl(var(--secondary)) 100%)',
      },
    },
  },
