...
import {
  ParallaxLayer,
  FloatingElement,
} from "@/components/animations/ParallaxLayer";
...
const gameCharacters = [
  ...
  { image: soccerPlayer, genre: "SOCCER", glowColor: "#00ff6b" },
  { image: battleRoyale, genre: "BR", glowColor: "#ffff00" },
  { image: mobaMage, genre: "MOBA", glowColor: "#bf00ff" },
  { image: racingDriver, genre: "RACING", glowColor: "#ff00bf" },
  { image: fighter, genre: "FIGHTING", glowColor: "#ff4444" },
  { image: cardWizard, genre: "CARDS", glowColor: "#00ffbf" },
  { image: basketballPlayer, genre: "BASKETBALL", glowColor: "#ff6600" },
];
...
const platformStats = [
  ...
  { value: "2,500+", label: "Tournaments Hosted", icon: Trophy },
...
const orgBenefits = [
  {
    ...
    desc: "Use esports tools in minutes with full platform support",
  },
  {
    icon: Users,
    title: "Manage your Roster",
    desc: "Add players, collaborate, and manage your competitive staff",
  },
  {
    icon: Trophy,
    title: "Host Tournaments",
    desc: "Create exclusive events with automatic bracket generation",
  },
  {
    icon: BarChart3,
    title: "Track Metrics",
    desc: "Exclusive dashboard with performance and engagement stats",
  },
];
    ...
    <div className="flex flex-col bg-background min-h-screen overflow-x-hidden">
      ...
      >
        ...
        <FloatingLight
          ...
          color="hsl(300 100% 60% / 0.12)"
          size={350}
          delay={4}
        />
        <FloatingLight
          className="top-1/2 right-1/3"
          color="hsl(270 100% 65% / 0.1)"
          size={300}
          delay={2}
        />
            ...
            <div className="space-y-6">
                ...
                <ParallaxLayer speed={0.08}>
                  <div className="relative max-w-md group">
                    <motion.div
                      ...
                      whileHover={{
                        boxShadow:
                          "0 25px 60px -15px hsl(185 100% 50% / 0.25)",
              ...
              <AnimatedSection delay={0.4} direction="up">
                <p className="text-lg text-muted-foreground max-w-lg leading-relaxed">
                  Organize professional tournaments, manage athletes, track stats,
                  and build a competitive career.{" "}
              ...
              <AnimatedSection delay={0.5} direction="up">
                <div className="flex flex-wrap gap-6 text-sm text-muted-foreground">
                  {[
                    { color: "bg-success", text: "1,965 players", pulse: true },
                    { color: "bg-primary", text: "High action" },
                    { color: "bg-warning", text: "View previews" },
                  ].map((item, i) => (
                    <motion.span
                      key={i}
                ...
                >
                  ...
                  <div className="flex items-center justify-between px-5 py-4 border-b border-border/30 bg-surface-2/30">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-xs text-success font-medium uppercase">
                        Online
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <StaggerContainer staggerDelay={0.1}>
                      <div className="grid grid-cols-3 gap-3">
                        {[
                          { value: "2,847", label: "Players Online" },
                          { value: "156", label: "Matches Today" },
                          { value: "23", label: "Active Tournaments" },
                        ].map((stat, i) => (
                          <StaggerItem key={i}>
                            <motion.div
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-semibold text-foreground">EFA Brazil Cup</div>
                          <div className="text-sm text-muted-foreground">
                            33 Prêtes • 12 Online Tournaments
                          </div>
                        </div>
                      </div>
                    </motion.div>
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <FloatingLight
          ...
          color="hsl(300 100% 60% / 0.1)"
          size={400}
          delay={2}
        />
        <FloatingLight
          className="bottom-1/3 left-1/5"
          color="hsl(185 100% 50% / 0.08)"
          size={350}
        />
              ...
              <AnimatedSection direction="left">
                <div className="space-y-4">
                  <motion.div
                    ...
                    whileHover={{
                      scale: 1.05,
                      backgroundColor: "hsl(300 100% 60% / 0.1)",
                    }}
                  >
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    On EFA you can build your own esports organization, manage teams
                    across multiple games, host exclusive tournaments, and grow a
                    professional competitive community.
                  </p>
                </div>
              </AnimatedSection>
              ...
              <ParallaxLayer speed={0.1}>
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    whileHover={{
                      boxShadow:
                        "0 30px 70px -20px hsl(300 100% 60% / 0.25)",
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <FloatingLight
          className="top-1/3 left-1/6"
          color="hsl(270 100% 65% / 0.08)"
          size={300}
          delay={1}
        />
        <FloatingLight
        ...
        <div className="container relative">
          ...
          <AnimatedSection>
            <div className="text-center mb-16 space-y-4">
              <motion.div
                ...
                whileHover={{
                  scale: 1.05,
                  backgroundColor: "hsl(270 100% 65% / 0.1)",
                }}
              >
          ...
          <div className="relative">
            ...
            <motion.button
              ...
              className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 h-12 w-12 rounded-full bg-surface-2/60 backdrop-blur border border-border/30 flex items-center justify-center transition-all duration-300 ${
                !canScrollLeft ? "opacity-30 cursor-not-allowed" : ""
              }`}
              whileHover={
                canScrollLeft
                  ? { scale: 1.1, borderColor: "hsl(270 100% 65% / 0.5)" }
                  : {}
              }
            ...
            <motion.button
              ...
              className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 h-12 w-12 rounded-full bg-surface-2/60 backdrop-blur border border-border/30 flex items-center justify-center transition-all duration-300 ${
                    ...
                    <motion.div className="mt-4 text-center">
                      <span
                        ...
                        style={{
                          ...
                          textShadow: `0 0 15px ${char.glowColor}`,
                        }}
                      >
                        {char.genre}
                      </span>
          ...
          <StaggerContainer staggerDelay={0.2}>
            <div className="mt-14 flex flex-wrap justify-center gap-12 md:gap-20">
              {[
                { value: "+20", label: "supported game genres", color: "text-primary" },
                { value: "9", label: "characters", color: "text-secondary" },
        ...
        <div className="container relative">
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto space-y-8">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Join thousands of players and organizations already competing on EFA.
