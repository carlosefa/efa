        ...
        <div className="container">
          <div className="flex h-16 lg:h-18 items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {user ? (
                // ✅ OPTION 2: Badge/Pill Dashboard (replaces button)
                <Link
                  to="/dashboard"
                  className={cn(
                    "hidden sm:flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-1.5 text-primary transition hover:bg-primary/20"
                    // If you insist on keeping your cyber-btn glow, uncomment:
                    // ,"cyber-btn"
                  )}
                >
                  <span className="text-xs font-semibold tracking-normal whitespace-nowrap leading-none">
                    {t("nav.dashboard")}
                  </span>
                ...
                <>
                  ...
                  <Button
                    asChild
                    className="cyber-btn bg-primary hover:bg-primary/90 text-primary-foreground relative overflow-hidden group"
                  >
                    <Link to="/auth">
                      <span className="text-xs font-semibold tracking-wider relative z-10">
                        {t("nav.signup")}
                      </span>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <nav className="relative z-50 pt-20 px-6 space-y-2">
            ...
            {!user && (
              <div
                className="pt-4 space-y-2 animate-fade-in"
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a
                    href="https://discord.gg/efaesports"
                    target="_blank"
